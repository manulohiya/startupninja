...
// db.on('error', console.error.bind(console, 'Database Connection Error:'));
 	...
 	var company = ["Chat Roulette","Tinder", "altSchool", "Medium", "Zipcar", "General Assembly", "HotelTonight", "BirchBox", "Waze", "uber", "airbnb", "Snapchat", "SpaceX", "Dropbox", "Spotify", "Venmo", "Slack", "Tesla", "Lyft", "Instacart", "Blue Apron", "Netflix", "Google Docs", "Gilt", "Shazam", "Lending Club", "Zillow", "HBO", "ebay", "amazon", "PayPal", "Github", "Vine", "Squarespace", "Pandora", "Soundcloud", "Spotify", "Etsy", "Youtube", "Yelp", "ProductHunt", "Google Maps", "Postmates", "Facebook", "LinkedIn", "Seamless", "Pinterest", "Instagram"];
